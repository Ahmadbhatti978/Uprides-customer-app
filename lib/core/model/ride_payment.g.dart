...
_RidePaymentModel _$RidePaymentModelFromJson(Map<String, dynamic> json) =>
    _RidePaymentModel(
      payload: _$JsonConverterFromJson<String, RidePaymentPayload>(
          json['payload'], const RidePaymentPayloadConverter().fromJson),
      body: json['body'] as String?,
    );

Map<String, dynamic> _$RidePaymentModelToJson(_RidePaymentModel instance) =>
    <String, dynamic>{
      'payload': _$JsonConverterToJson<String, RidePaymentPayload>(
          instance.payload, const RidePaymentPayloadConverter().toJson),
      'body': instance.body,
    };
...
_Location _$LocationFromJson(Map<String, dynamic> json) => _Location(
      dropOff: json['drop_off'] == null
          ? null
          : LocationPoint.fromJson(json['drop_off'] as Map<String, dynamic>),
