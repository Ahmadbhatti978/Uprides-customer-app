...
final Map<String, String> referral = {"Refer a friend": AppRoutes.referAFriend, "+ Add a referral": AppRoutes.addReferral};
...
class Referral extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: const NameBackBar(title: 'Referral'),
    body: Column(
      spacing: 2,
      children: referral.entries.map((entry) => ReferralContainer(title: entry.key, onTap: () => Navigator.pushNamed(context, entry.value))).toList(),
    ),
  );
}
